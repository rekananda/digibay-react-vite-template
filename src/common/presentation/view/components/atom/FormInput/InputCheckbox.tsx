import { Box, Checkbox, CheckboxCard, CheckboxGroup, CheckboxGroupProps, CheckboxIndicator, CheckboxProps, Grid, GridCol, GridProps, Group, ScrollAreaAutosize, Stack, Text, Tooltip } from '@mantine/core';
...
export const InputCheckboxGroup = (props: PropsInputCheckboxGroup) => {
  ...
  return (
    ...
    >
      <ScrollAreaAutosize mah={dataProps?.mah} h="100%">
        <Grid columns={4} {...dataProps} className='kanjut' style={{marginTop: "calc(var(--mantine-spacing-xs) / 2)"}}>
          {data.map((option, i) => 
