...
export const mantineColor:Record<ExtendedColors, MantineColorsTuple> = {
  primary: [ "#F3F0FF", "#E5DBFF", "#D0BFFF", "#B197FC", "#9775FA", "#845EF7", "#7950F2", "#7048E8", "#6741D9", "#5F3DC4" ],
  secondary: [ "#E3FAFC", "#C5F6FA", "#99E9F2", "#66D9E8", "#3BC9DB", "#22B8CF", "#15AABF", "#1098AD", "#0C8599", "#0B7285" ],
...
const themeOverride:MantineThemeOverride = createTheme({
  ...
  components: {
    Card: {
      defaultProps: {
        style: {
          background: "var(--mantine-background-card) !important",
          radius: "8px"
        }
      }
    },
